...
BarPill {
    ...
    content: Row {
        property color accent: detailWindowOpen ? Theme.text : Theme.textMuted
                ...
                GridLayout {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            color: index < loaOverview.cols || (index % loaOverview.cols === 0) ? Theme.surface : canPlan && modelData.planned ? Theme.surfaceHover : cellMouse.containsMouse && canPlan ? Theme.surfaceHover : Theme.surface
                            border.color: canPlan && modelData.planned ? modelData.planned.color : Theme.border
                            ...
                            Text {
                                ...
                                color: parent.canPlan && modelData.text === "" ? Theme.accent : Theme.text
                ...
                GridLayout {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            color: modelData.type === "header" || modelData.type === "character" ? Theme.surface : canPlan && modelData.planned ? Theme.surfaceHover : cellMouse.containsMouse && canPlan ? Theme.surfaceHover : Theme.surface
                            border.color: canPlan && modelData.planned ? modelData.planned.color : Theme.border
                            border.width: canPlan && modelData.planned ? 1 : 0
    ...
    component LoaWeekButton: Rectangle {
        ...
        radius: 6
        color: buttonMouse.containsMouse && enabled ? Theme.surfaceHover : Theme.surface
        border.color: enabled ? Theme.border : Theme.surface
        border.width: 1
    ...
    component LoaActionButton: Rectangle {
        ...
        Layout.preferredHeight: 24
        radius: 5
        color: primary ? Theme.accent : danger ? Theme.urgent : buttonMouse.containsMouse && enabled ? Theme.surfaceHover : Theme.surface
        border.color: primary ? Theme.accent : danger ? Theme.urgent : Theme.border
        border.width: 1
        opacity: enabled ? 1 : 0.45

        Text {
            anchors.centerIn: parent
            color: button.primary || button.danger ? Theme.bg : Theme.text
            font.pixelSize: 9
            font.weight: Font.Bold
            text: button.label
        }
