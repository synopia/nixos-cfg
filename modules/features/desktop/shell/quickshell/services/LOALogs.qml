...
Singleton {
        ...
        return [
            ...
            },
            {
                ...
                colors: {
                    "Normal": Theme.difficultyNormal,
                    "Hard": Theme.difficultyHard,
                    "Nightmare": Theme.difficultyNightmare
                }
            },
            {
                raid: "Cath",
                ...
                colors: {
                    "Level 1": Theme.difficultyNormal,
                    "Level 2": Theme.difficultyHard,
                    "Level 3": Theme.difficultyNightmare
                }
            }
        ];
    }
    ...
    function defaultDifficultyColor(difficulty) {
        ...
        default:
            return Theme.difficultyNightmare;
        }
    }
    ...
    function raidColor(raid, difficulty) {
        ...
        if (!group)
            return Theme.difficultyNormal;
        return group.colors[validDifficulty(raid, difficulty)] || Theme.difficultyNormal;
    }
    ...
    function overviewRaidMarks(group, characterRaids) {
        ...
        const marks = group.gates.map(gate => {
            ...
            return `<b style="color:${Theme.textMuted}">○</b>`;
        });
        return {
            text: marks.join(""),
            cleared: cleared
